...
import { IntervalTimeline } from 'core';
	 ...
	 *  @name latencyHint
	 */
	Object.defineProperty(Transport.prototype, "latencyHint", {
		get : function(){
	 ...
	 *  @private
	 */
	Transport.prototype._fromUnits = function(bpm){
	 ...
	 *  @private
	 */
	Transport.prototype._toUnits = function(freq){
